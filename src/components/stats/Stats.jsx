        ...
        <div className="stats__grid container grid">
            <div className="stats__item">
                <div className="stats__img-wrapper">
                    <img className='stats__img' src={coffeeShop} alt="" />
                </div>
                <div>
            ...
            <div className="stats__item">
                <div className="stats__img-wrapper">
                    <img className='stats__img' src={coffeeCup} alt="" />
                </div>
                <div>
            ...
            <div className="stats__item">
                <div className="stats__img-wrapper">
                    <img className='stats__img' src={chef} alt="" />
                </div>
                <div>
            ...
            <div className="stats__item">
                <div className="stats__img-wrapper">
                    <img className='stats__img' src={experience} alt="" />
                </div>
                <div>
